...
function incrementCount(id) {
    ...
    let currentCount = parseInt(countElement.innerText) || 0; // Controllo per `NaN`
    currentCount++;
...
function updateRanking() {
    ...
    rows.sort((a, b) => {
        const countA = parseInt(a.querySelector('td[data-id]').innerText) || 0;
        const countB = parseInt(b.querySelector('td[data-id]').innerText) || 0;
